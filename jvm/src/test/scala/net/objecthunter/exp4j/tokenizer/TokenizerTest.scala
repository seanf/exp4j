...
class TokenizerTest {
  ...
  def testTokenization1(): Unit = {
    val tokenizer = new Tokenizer("1.222331", Map(), Map(), Set())
  ...
  def testTokenization2(): Unit = {
    val tokenizer = new Tokenizer(".222331", Map(), Map(), Set())
  ...
  def testTokenization3(): Unit = {
    val tokenizer = new Tokenizer("3e2", Map(), Map(), Set())
  ...
  def testTokenization4(): Unit = {
    val tokenizer = new Tokenizer("3+1", Map(), Map(), Set())
  ...
  def testTokenization5(): Unit = {
    val tokenizer = new Tokenizer("+3", Map(), Map(), Set())
    assertTrue(tokenizer.hasNext)
  ...
  def testTokenization8(): Unit = {
    val tokenizer = new Tokenizer("---++-3.004", Map(), Map(), Set())
    assertTrue(tokenizer.hasNext)
    assertOperatorToken(tokenizer.nextToken, "-", 1, Operator.PRECEDENCE_UNARY_MINUS)
    assertTrue(tokenizer.hasNext)
    assertOperatorToken(tokenizer.nextToken, "-", 1, Operator.PRECEDENCE_UNARY_MINUS)
  ...
  def testTokenization10(): Unit = {
    val tokenizer = new Tokenizer("3+-1-.32++2", Map(), Map(), Set())
    assertTrue(tokenizer.hasNext)
    assertNumberToken(tokenizer.nextToken, 3d)
    assertTrue(tokenizer.hasNext)
    assertOperatorToken(tokenizer.nextToken, "+", 2, Operator.PRECEDENCE_ADDITION)
  ...
  def testTokenization11(): Unit = {
    val tokenizer = new Tokenizer("2+", Map(), Map(), Set())
    assertTrue(tokenizer.hasNext)
    assertNumberToken(tokenizer.nextToken, 2d)
    assertTrue(tokenizer.hasNext)
    assertOperatorToken(tokenizer.nextToken, "+", 2, Operator.PRECEDENCE_ADDITION)
  ...
  def testTokenization12(): Unit = {
    val tokenizer = new Tokenizer("log(1)", Map(), Map(), Set())
    assertTrue(tokenizer.hasNext)
  ...
  def testTokenization13(): Unit = {
    val tokenizer = new Tokenizer("x", Map(), Map(), Set("x"))
    assertTrue(tokenizer.hasNext)
  ...
  def testTokenization14(): Unit = {
    val tokenizer = new Tokenizer("2*x-log(3)", Map(), Map(), Set("x"))
    assertTrue(tokenizer.hasNext)
    assertNumberToken(tokenizer.nextToken, 2d)
    assertTrue(tokenizer.hasNext)
  ...
  def testTokenization15(): Unit = {
    val tokenizer = new Tokenizer("2*xlog+log(3)", Map(), Map(), Set("xlog"))
    assertTrue(tokenizer.hasNext)
    assertNumberToken(tokenizer.nextToken, 2d)
    assertTrue(tokenizer.hasNext)
    assertOperatorToken(tokenizer.nextToken, "*", 2, Operator.PRECEDENCE_MULTIPLICATION)
  ...
  def testTokenization18(): Unit = {
    ...
    val funcs = Map(log2.getName -> log2)
    val tokenizer = new Tokenizer("log2(4)", funcs, Map(), Set())
    assertTrue(tokenizer.hasNext)
  ...
  def testTokenization19(): Unit = {
    ...
    val funcs = Map(avg.getName -> avg)
    val tokenizer = new Tokenizer("avg(1,2)", funcs, Map(), Set())
    assertTrue(tokenizer.hasNext)
  ...
  def testTokenization20(): Unit = {
    ...
    val operators = Map(factorial.getSymbol -> factorial)
    val tokenizer = new Tokenizer("2!", Map(), operators, Set())
    assertTrue(tokenizer.hasNext)
    assertNumberToken(tokenizer.nextToken, 2d)
    assertTrue(tokenizer.hasNext)
  ...
  def testTokenization21(): Unit = {
    val tokenizer = new Tokenizer("log(x) - y * (sqrt(x^cos(y)))", Map(), Map(), Set("x", "y"))
    assertTrue(tokenizer.hasNext)
    assertFunctionToken(tokenizer.nextToken, "log", 1)
    assertTrue(tokenizer.hasNext)
    assertOpenParenthesesToken(tokenizer.nextToken)
  ...
  def testTokenization22(): Unit = {
    val tokenizer = new Tokenizer("--2 * (-14)", Map(), Map(), Set())
    assertTrue(tokenizer.hasNext)
    assertOperatorToken(tokenizer.nextToken, "-", 1, Operator.PRECEDENCE_UNARY_MINUS)
    assertTrue(tokenizer.hasNext)
    assertOperatorToken(tokenizer.nextToken, "-", 1, Operator.PRECEDENCE_UNARY_MINUS)
